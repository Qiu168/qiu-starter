...
import com.cat.utils.EncryptUtil;
...
public class MybatisEncryptInterceptor implements Interceptor {
    ...
    public Object plugin(Object target) {
        if (target instanceof ParameterHandler) {
            // 进行加密操作
            EncryptSituation encryptSituation = EncryptHelper.getEncryptSituation();
            if (encryptSituation != null && encryptSituation.isCancelEncrypt()) {
                return target;
            }
    ...
    @SuppressWarnings("all")
    public MybatisEncryptInterceptor(final EncryptorManager encryptorManager, final EncryptorProperties defaultProperties) {
