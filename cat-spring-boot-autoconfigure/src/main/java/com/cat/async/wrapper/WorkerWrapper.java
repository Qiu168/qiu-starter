package com.cat.async.wrapper;


import com.cat.async.callback.DefaultCallback;
import com.cat.async.callback.ICallback;
import com.cat.async.callback.IWorker;
import com.cat.async.exception.SkippedException;
import com.cat.async.executor.timer.SystemClock;
import com.cat.async.worker.DependWrapper;
import com.cat.async.worker.ResultState;
import com.cat.async.worker.WorkResult;
